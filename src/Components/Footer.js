      ...
      <footer class="footer">
        ...
        <div class="footer-top section">
          <div class="container">
            ...
            <ul class="footer-list">
              ...
              <li>
                <a href="#" class="footer-link">Research & Development</a>
              </li>
              ...
              <li>
                <a href="#" class="footer-link">Social Media Mangement</a>
              </li>
        ...
        <div class="footer-bottom">
          <div class="container">
            ...
            <p class="copyright">
              &copy; 2024  | All Rights Reserved by <a href="#" class="copyright-link">INFIEDGE</a>
            </p>
